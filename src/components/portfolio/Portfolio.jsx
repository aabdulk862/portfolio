...
import IMG3 from '../../assets/paint-clone.png'
...
const data = [
  {
    id: 1,
    image: IMG1,
    title: 'Royal Clothing Outlet - Ecommerce site made with React, Redux, Stripe, Firebase.',
  ...
  },
  {
    id: 3,
    image: IMG3,
    title: 'Paint Clone - Allows user save their work as an image and to local storage.',
    github: 'https://github.com/aabdulk862/paint-clone-js',
